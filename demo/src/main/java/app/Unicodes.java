...
public class Unicodes{
    ...
    public final static String yellowBackground = "\u001B[43m";
    public final static String blueBackground = "\u001B[44m";
    public final static String purpleBackground = "\u001B[45m";
    ...
    public final static String boldOff = "\u001B[22m";
